...
MangaDownloadWidget::MangaDownloadWidget(QWidget* parent, const QDir& scansDirectory) :
    QWidget(parent),
...
//    _chaptersOnPCModel->insertRow(0);
//    _chaptersOnPCModel->insertRow(1);
//    _chaptersOnPCModel->insertRow(2);
//    _chaptersOnPCModel->insertRow(3);
//    _chaptersOnPCModel->setData(_chaptersOnPCModel->index(0), "dkfhduhfu");
//    _chaptersOnPCModel->setData(_chaptersOnPCModel->index(1), "dkfhduhfu");
//    _chaptersOnPCModel->setData(_chaptersOnPCModel->index(2), "dkfhduhfu");
//    _chaptersOnPCModel->setData(_chaptersOnPCModel->index(3), "dkfhduhfu");
...
//    _chaptersOnPCView->setDragDropMode(QAbstractItemView::DropOnly);
    ...
    _updateButton->setIcon(QIcon("../MangaReader/icons/reload.png"));
    ...
    _downloadButton->setIcon(QIcon("../MangaReader/icons/leftArrow.gif"));
    ...
    _selectAllButton->setIcon(QIcon("../MangaReader/icons/selectAll.gif"));
...
//    _chaptersOnWebModel->insertRow(0);
//    _chaptersOnWebModel->insertRow(1);
//    _chaptersOnWebModel->insertRow(2);
//    _chaptersOnWebModel->insertRow(3);
//    _chaptersOnWebModel->setData(_chaptersOnWebModel->index(0), "qlsjdlfbz");
//    _chaptersOnWebModel->setData(_chaptersOnWebModel->index(1), "qlsjdlfbz");
//    _chaptersOnWebModel->setData(_chaptersOnWebModel->index(2), "qlsjdlfbz");
//    _chaptersOnWebModel->setData(_chaptersOnWebModel->index(3), "qlsjdlfbz");
    ...
    _clearTextEditButton->setIcon(QIcon("../MangaReader/icons/clean.png"));
    ...
    _stopButton->setIcon(QIcon("../MangaReader/icons/stop.png"));
    ...
    _pauseResumeButton->setIcon(QIcon("../MangaReader/icons/pause.png"));
...
void MangaDownloadWidget::pauseResumeDownload(bool check) {
    ...
    if (_pauseResumeButton->isChecked()) {
        _pauseResumeButton->setIcon(QIcon("../MangaReader/icons/resume.png"));
