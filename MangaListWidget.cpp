...
MangaListWidget::MangaListWidget(QWidget* parent, const QDir& scansDirectory) :
    QWidget(parent),
    ...
    _markReadButton->setIcon(QIcon("../MangaReader/icons/check.gif"));
    ...
    _markUnreadButton->setIcon(QIcon("../MangaReader/icons/uncheck.gif"));
    ...
    _downloadButton->setIcon(QIcon("../MangaReader/icons/download.gif"));
    ...
    _addMangaButton->setIcon(QIcon("../MangaReader/icons/plus.png"));
...
void MangaListWidget::initModel(void) {
    ...
    foreach (const QString& mangaName, dirsList) {
        ...
        currItem->setData(QIcon("../MangaReader/icons/uncomplete.png"), Qt::DecorationRole);
        ...
        foreach (const QString& currChStr, currDirsList) {
            ...
            if (currChStr.endsWith("-END"))
                currItem->setData(QIcon("../MangaReader/icons/complete.png"), Qt::DecorationRole);
...
void MangaListWidget::setTextAccordingToRead(QStandardItem* chapterItem, bool read) {
    if (read) {
        chapterItem->setIcon(QIcon("../MangaReader/icons/check.gif"));
        chapterItem->setFont(QFont(""));
    } else {
        chapterItem->setIcon(QIcon("../MangaReader/icons/uncheck.gif"));
